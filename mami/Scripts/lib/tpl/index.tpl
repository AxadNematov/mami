			...
			<div id="divcent">
				<div id="main">
					<div id="about">
						...
						<p style="text-align: justify; font-size: 11px; color: #A1A1A1">{$about}</p>
				...
				<div id="accord_menu_r">
					...
					<div id="cert_cmp_div" class="accord_div_r">
						<div style="width: 100%; height: auto; margin-bottom: 10px;">
							{section name=cert loop=$cpics_c}
								<img class="certimgs" src="{$cpics_c[cert][1]}" alt="{$cpics_c[cert][2]}"/>
							{/section}
						</div>
					</div>
					...
					<div id="cert_prt_div" class="accord_div_r">
						<div style="width: 100%; height: auto; margin-bottom: 10px;">
							{section name=cert loop=$cpics_p}
								<img class="certimgs" src="{$cpics_p[cert][1]}" alt="{$cpics_p[cert][2]}"/>
							{/section}
						</div>
					</div>
					...
					<div id="cert_ref_div" class="accord_div_r">
						<div style="width: 100%; height: auto; margin-bottom: 10px;">
							{section name=cert loop=$cpics_r}
								<img class="certimgs" src="{$cpics_r[cert][1]}" alt="{$cpics_r[cert][2]}"/>
							{/section}
						</div>
					</div>
				</div>	
